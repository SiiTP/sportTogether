...
class EventsDAO extends DatabaseDAO[MapEvent,Int]{
  ...
  def getNearestEventsByDistance(distance:Double, longtitude: Double, latitude: Double) = {
    implicit val getEventResult = GetResult(r => MapEvent(r.nextString, r.nextInt, r.nextDouble, r.nextDouble, r.nextTimestamp, r.nextInt, r.nextInt, r.nextStringOption, r.nextBoolean(), r.nextIntOption, r.nextIntOption))
...
class DistanceQuery(val distance: Double, val longtitude: Double, val latitude: Double) {
  ...
  def distanceQuery ={
    implicit val getEventResult = GetResult[MapEvent](r => MapEvent(r.nextString, r.nextInt, r.nextDouble, r.nextDouble, r.nextTimestamp, r.nextInt, r.nextInt, r.nextStringOption, r.nextBoolean(), r.nextIntOption, r.nextIntOption))
